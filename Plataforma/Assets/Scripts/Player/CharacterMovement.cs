...
public class CharacterMovement : MonoBehaviour
{
    ...
    public AudioClip jumpAudio; //audio para cuando salta el jugador
    public AudioClip espadasAudio; //audio para cuando lanza la espada jugador
    ...
    void Update()
    {
        ...
        if (isGrounded && Input.GetKeyDown(KeyCode.Space) )
        {
            ...
            audio.PlayOneShot(jumpAudio); //audio para saltar
        }
    }
    ...
    public void CallFireProjectil()
    {
        ...
        audio.PlayOneShot(espadasAudio);
    }
}
